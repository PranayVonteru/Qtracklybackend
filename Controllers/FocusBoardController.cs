...
//        //    {
//        //        var userId = GetCurrentUserId();
//        //        var tasks = await _focusBoardService.GetWaitingTasksAsync(userId);
//        //        return Ok(tasks);
//        //    }
//        //    catch (UnauthorizedAccessException ex)
//        //    {
...
//        //    catch (Exception ex)
//        //    {
//        //        return StatusCode(500, new { message = "Failed to fetch waiting tasks.", error = ex.Message });
//        //    }
//        //}
...
//        //public async Task<List<TaskDependencyDto>> GetDependencyTasksAsync(string userId)
//        //{
//        //    return await _focusBoardService.GetDependentTasksByUserAsync(userId);
//        //}

//        [HttpGet("DependentTasks/{userId}")]

//        public async Task<Object> GetDependentTasksAsync(string userId)
//        {
//            return await _focusBoardService.GetDependentTasksByUserAsync(userId);
//        }
...
//        public async Task<Object> GetDependencyTasksAsync(string userId)
//        {
//            return await _focusBoardService.GetDependencyTasksByUserAsync(userId);
//        }
