...
////builder.Services.AddScoped<ITaskLogService, TaskLogService>(); // Added
////builder.Services.AddScoped<ITimesheetService, TimesheetService>(); // Added
...
//    options.AddPolicy("AllowSpecificOrigin",
//        builder => builder
//            .WithOrigins("http://localhost:5173", "http://localhost:3000", "https://localhost:5173") // Added https domain for production
//            .AllowAnyMethod()
//            .AllowAnyHeader()
//            .AllowCredentials());
//});
